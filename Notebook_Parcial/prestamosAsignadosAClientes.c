...
{
    int contadorPrestamosOtorgados=0;
    int i=0;

    for(i=0; i<len; i++)
    {
        if(!buscarPrimerPosicionVaciaPrestamo(aPrestamo, len))
        {
            contadorPrestamosOtorgados++;
        }
    }
    return contadorPrestamosOtorgados;
}
